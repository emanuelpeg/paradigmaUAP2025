...
-- Ejercicio 3: Fibonacci //Se llama a llamar 2 veces a si mismo en cada iteracion, entonces es 2 elevado a la n
...
fibonacciHelper : Int -> Int -> Int -> Int --Recibe 3 enteros y devuelve 1 entero
...
reverseHelper n acc =
    ...
    else reverseHelper (n // 10) (acc * 1) + (modBy 10 n)
