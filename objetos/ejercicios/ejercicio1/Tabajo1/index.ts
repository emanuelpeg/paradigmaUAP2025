...
import { EventoBiblioteca } from "./eventoDeBiblioteca";
...
console.log(socio1.avisos);

// Mostrar historial de notificaciones de algunos socios
console.log("Historial de notificaciones de socio1:");
socio1.avisos.forEach(n => console.log(`[${n.fecha.toLocaleString()}] ${n.mensaje}`));

console.log("Historial de notificaciones de socio2:");
socio2.avisos.forEach(n => console.log(`[${n.fecha.toLocaleString()}] ${n.mensaje}`));
console.log("Historial de notificaciones de socio3:");
socio3.avisos.forEach(n=> console.log(`[${n.fecha.toLocaleString()}] ${n.mensaje}`));

 // Simula que socio1 lee dos libros de George Orwell
