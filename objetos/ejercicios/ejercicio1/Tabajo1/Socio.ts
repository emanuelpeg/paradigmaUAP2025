...
export class Socio {
    ...
    //privatiza todos los parametros para que no cualquiera los pueda modificar
        ...
        private _historialAvisos: Aviso[] = []
    ) {}
  ...
  //permite leer x parametros
    ...
    agregarAviso(mensaje: string) {
        this._historialAvisos.push(new Aviso(mensaje));
    }
}