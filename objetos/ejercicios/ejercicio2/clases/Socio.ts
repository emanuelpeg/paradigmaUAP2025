...
import { PrestamoCorto, PrestamoRegular, PrestamoReferencia, PrestamoDigital } from "./Prestamo";
...
protected abstract crearPrestamo(libro: Libro): Prestamo;
  ...
  retirar(libro: Libro, duracion?: Duracion) {
    ...
    const prestamo = this.crearPrestamo(libro);
...
export class SocioRegular extends Socio {
  ...
  protected crearPrestamo(libro: Libro): Prestamo {
  return new PrestamoCorto(this, libro); // Regular → Corto
  }
...
export class SocioVIP extends Socio {
  ...
  protected crearPrestamo(libro: Libro): Prestamo {
  return new PrestamoRegular(this, libro);
}
...
export class Empleado extends Socio {
  ...
  protected crearPrestamo(libro: Libro): Prestamo {
  return new PrestamoDigital(this, libro);
}
...
export class Visitante extends Socio {
  ...
  protected crearPrestamo(libro: Libro): Prestamo {
  return new PrestamoReferencia(this, libro);
}
