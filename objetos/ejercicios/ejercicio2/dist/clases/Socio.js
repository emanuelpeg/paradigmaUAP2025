...
class Socio {
    ...
    tienePrestadoLibro(libro) {
        var _a;
        return (_a = this.prestamos.find((p) => p.libro === libro)) !== null && _a !== void 0 ? _a : null;
    }
    ...
    recomendacionesSimples() {
        const autores = new Set(this.historialLectura.map((l) => { var _a; return (_a = l.autor.nombre) !== null && _a !== void 0 ? _a : l.autor; }));
